...
**개발 초기 단계입니다.** 지금은 라우팅, 테마, 저장소 계층을 갖춘 앱 골격까지 구현되어 있고 GitHub 연동은 아직 없습니다. 전체 범위와 진행 순서는 [plan.md](./plan.md)에 정의되어 있습니다.

| 단계 | 내용 | 상태 |
| --- | --- | --- |
| 0 | 기반 정리, 툴체인, CI | 진행 중 |
| 1 | 인증, 설정, PR 불러오기 | 예정 |
| 2 | 번역 파일 발견과 데이터 모델 | 예정 |
| 3 | 전체 파일 3열 diff | 예정 |
| 4 | Viewed와 기존 리뷰 대화 | 예정 |
| 5 | 댓글 및 리뷰 제출 | 예정 |
| 6 | 갱신 안정성과 마무리 | 예정 |
